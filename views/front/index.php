		...
		<div class="banner-text"> 
			<div class="container"> 
				<div class="banner-w3lstext"> 
					<h2>Welcome<span>Mimosas Restaurant</span></h2>
					<p></p>
				</div> 
			</div>
		</div>
...
?>
					<div class="crud" style="right: 150px">
						<center>
							<td><a href="contact.html">Mailing</a></td>
						<table >
							<td></td>
                            ...
                            <figure>
                                 ...
                                 <td>
                                 	...
                                 	<div><img src="../../images/<?php echo $row['image'];?>" alt="" style="border-radius:60%;width: 50%"></div> </MARQUEE>
                                       <h4>Titre: <?php echo $row['nom']; ?></h4>
                                       <span>date debut: <?php echo $row ['date']; ?></span>
                                       <span>datefin: <?php echo $row ['fin']; ?></span>
								...
								<td><form method="POST" action="participation.php">
			<input type="submit" name="participer" value="participer" id="btn1" onclick="disableButton(this)"
			 <?php if ($row['nbmax']==0  ) { ?> disabled  <?php  } ?> >
